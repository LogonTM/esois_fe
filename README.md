Ma jätan praegu all olev tekst kuna see esialgu aitab kiiresti leida info projekti loomise kohta.

Laadige alla kood ning käsuga "yarn start" peaks reacti app käima minna.

Olemas olevatel komponentidel on natukene teine kood tuleb aru saada kas selle saab kuidagi tööle saada või tuleb kohandada nagu mina tegin "footer.jsx"-ga.
